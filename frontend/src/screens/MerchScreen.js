...
import { MERCH_PRODUCTS, MERCH_STORE_INFO } from '../merch/products';
...
// accents, white product-photo tiles, bold all-caps taglines. Real product
// data/imagery only (see ../merch/products.js) — nothing invented here.
